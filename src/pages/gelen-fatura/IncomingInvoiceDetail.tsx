  ...
  if (!invoice) {
    return (
      <div>
        ...
        <Button onClick={() => navigate('/gelen-fatura/alis')}>Geri Dön</Button>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" onClick={() => navigate('/gelen-fatura/alis')}>
          <ArrowLeft className="w-4 h-4 mr-2" />
          Geri
        </Button>
        <div>
          <h1 className="text-3xl font-bold">{invoice.invoiceNumber}</h1>
          <p className="text-slate-600 mt-2">Gelen Fatura Detayları</p>
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Vergi No: {invoice.supplierTaxId}</p>
            </div>
            <div>
